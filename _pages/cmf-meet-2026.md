...
**2026 Meeting program is available [here]({{ site.url }}{{ site.baseurl }}/assets/cama-flood/docs/CMF-meet2026_Program.pdf)**

**2026 Presentation Abstracts are available [here]({{ site.url }}{{ site.baseurl }}/assets/cama-flood/docs/CMF-meet2026_Abstracts.pdf)**

<img src="{{ site.url }}{{ site.baseurl }}/images/picture/cmf-meet2026.png" width="80%" />

(Group photo of 2026 meeting in ECMWF)

#### 2026 Meeting Awardee
Based on the votes by all participants, <span style="color: red">four presenters are awarded for their huge contribution to CaMa-Flood modelling community</span>.

**=== CaMa-Flood best developer award ===** <br>
**Nozomi Uemachi** (The University of Tokyo<br>
Extending CaMa-SED for Robust Continental-Scale Hydro-Sediment-Morphodynamic Modeling

**Do Ngoc Khanh** (Shibaura Institute of Technology<br>
A global levee database derived from high resolution digital elevation models


**=== CaMa-Flood best user/application award ===** <br>
**Faizal I. W. Rohmat** (Institut Teknologi Bandung)<br>
A Preliminary Regional-Scale Feasibility Assessment of CaMa-Flood for Flood Screening and Monitoring Support in Data-Scarce Regions of Indonesia

**=== CaMa-Flood early career award ===**<br>
**Hancheng Ren** (Beijing Normal University)<br>
GraphRiverCast: A Topology-Informed AI River Model for Global River Hydrodynamics
...
- 14 June: Deadline (Extended) - Registration with abstract submission
- 14 June: Deadline (Extended, early registration recommended) - Request of invitation letter for visa support (for participants requiring a visa)
