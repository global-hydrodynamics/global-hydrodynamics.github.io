---
title: "Yamazaki - CV (English)"
layout: pagelay
sitemap: false
permalink: /yamazaki-cv-e/
---
...
#### Unraveling the interactions between the global water cycle, climate, and society<br>through the integration of physical modeling and satellite observations of terrestrial water dynamics
...
[Japanese version CV is here](../yamazaki-cv-j)
...
- **[CaMa-Flood](../CaMa-Flood/)**: global river hydrodynamics model
- **[MERIT DEM](../MERIT_DEM/)**: high-accuracy global elevation dataset
- **[MERIT Hydro](../MERIT_Hydro/)**: global hydrography dataset
- **[J-FlwDir](../J-FlwDir/)**: Japan flow-direction map
- **[SplashTune!](../game-e/)**: rainfall–runoff modeling game
...
- **Associate Professor, [Institute of Industrial Science](https://www.iis.u-tokyo.ac.jp/), The University of Tokyo**
  - [Global Hydrodynamics Lab](../) Principal Investigator
...
- **Ph.D., Department of Civil Engineering, Graduate School of Engineering, The University of Tokyo** (Mar 2012)
  ...
  - [PhD Thesis PDF]({{ site.url }}{{ site.baseurl }}/assets/docs/Yamazaki_2012_Dpaper.pdf)
...
[Click here for Lab awards list](../award/)
